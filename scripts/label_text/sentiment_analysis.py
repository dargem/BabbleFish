...
from models.sentiment_classifier.distilbert_multilingual import Distilbert_Sentiment
...
OUTPUT_PATH = "/Users/td/Documents/GitHub/FinetunedMTLBot/data/preprocessed/structure_sentiment.json"


def conduct_sentiment_analysis():
    ...
    for sublist in segments:
        for segment_data in sublist:
            ...
            sentiment = sentiment_analyser.predict_sentiment(text)
